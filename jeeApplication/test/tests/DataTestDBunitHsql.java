...
public class DataTestDBunitHsql extends DBTestCase {
	/** Logger. */
	...
	private static final String DATABASE = "jdbc:hsqldb:file:test/tests/db/test";
	...
	public DataTestDBunitHsql(String name) {
		super(name);
		System.setProperty(
	...
	private IDataBaseSource getMockDataBaseSource() {
		return new DataBaseSourceHsqlPublic();
	}
